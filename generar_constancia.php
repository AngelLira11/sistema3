...
// Opciones de titulación exactas del nuevo PDF
$opciones_titulacion = [
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Logos ── */
        .encabezado-logos { margin-bottom: 0.3cm; }
        .encabezado-logos img { height: 1.45cm; width: auto; }
        ...
        .no-grupo     { display: flex; align-items: baseline; gap: 3px; }
...
<div class="documento">
    ...
    <div class="encabezado-logos">
        <img src="img/logo_header.png" alt="SEP / TecNM / ITL">
    </div>
    ...
    <table class="tabla-principal">
        <tr>
            ...
            <td class="celda-alumno">
                ...
                <!-- Nombre y No. Control en la misma línea -->
                <div class="campo-nombre-row">
                    <div class="nombre-grupo">
                        <span class="lbl">Nombre:</span>
                        <span class="val val-nombre"><?= htmlspecialchars($alumno['nombre']) ?></span>
                    </div>
                    <div class="no-grupo">
